...
export const bio = `Hi, I am roaming97, a passionate visual artist and graphic designer with a strong background in creating, designing, developing, and producing a wide range of content.
#
With several years of experience, I have honed my skills and developed a unique style that is both experimental and abstract, often incorporating geometric compositions in my work. Whether I am creating a static piece of art or a dynamic image sequence, I am always striving to get the best out of both worlds.
#
...
export const osSVGs = [
	{
		color: 'var(--fg-a)',
		size: 96,
		d: 'm465 245-227 2V79l227-33v199zM47 265v143l171 23V266l-171-1zm191 2v167l227 32V268l-227-1zM47 105v143l171-1V82L47 105z',
		caption: 'Windows'
	},
	{
		color: 'var(--fg-a)',
		...
		viewW: 496,
		viewH: 609,
		d: 'M274 53c40-53 95-53 95-53s9 50-31 97c-42 51-91 43-91 43s-9-40 27-87zm-22 122c21 0 59-29 109-29 85 0 119 61 119 61s-66 34-66 116c0 92 82 123 82 123s-57 162-135 162c-35 0-63-24-100-24-38 0-76 25-101 25C89 609 0 456 0 333c0-121 76-185 147-185 46 0 81 27 105 27z',
		caption: 'MacOS'
	},
	{
		color: 'var(--fg-a)',
