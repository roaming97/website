...
Some figured this one out already, but for those of you who did not:

<br />

`roaming -->` _'/AppData/Roaming'_ folder on Windows.

`97 -->` _Windows 9x_ because of vaporwave (explained further in next question).
...
designed the current logo from scratch to finally leave that dependency of another logo behind for good.
